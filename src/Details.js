  ...
  const accordionGroups = [
    ...
    },
    {
      ...
      description: ['技術分析分數（TA）。讀數從0最差到10最佳。',
        ...
        '相對強弱指數標準分數', '相對強弱指數 RSI 標準化分數是一個非趨勢指標，用於測量證券動量，以確定是否處於超買或超賣狀態。相對強度指數（RSI）讀數在0到100的範圍內擺動。70至80之間的讀數警告超買狀態，很可能遭遇向下修正。30至20之間讀數被認為是超賣條件，並警告即將出現向上修正。反轉警告發生在價格和RSI之間的分歧或匯聚之中。收益率從價格反面解釋，超過70表示超賣，低於30表示超買。']
    },
    {
      title: '',
